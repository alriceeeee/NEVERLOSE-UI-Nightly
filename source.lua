	...
	function WindowFunctinos:AddTab(TabNameString,IconType)
		...
		function TabFunctions:AddSection(SectionName,parentname)
			...
			function sectionfunc:AddColorPicker(ColorPickerName, DefaultColor, callback)
				...
				LabelText.ZIndex = 6
				LabelText.Font = Enum.Font.SourceSansSemibold
				LabelText.Text = ColorPickerName or "Color Picker"
				LabelText.TextColor3 = Color3.fromRGB(255, 255, 255)
				LabelText.TextScaled = true
				LabelText.TextSize = 14.000
				LabelText.TextTransparency = 0.300
				...
				ColorDisplay.Size = UDim2.new(0.980000019, 0, 0.75, 0)
				ColorDisplay.ZIndex = 5

				UICorner_2.CornerRadius = UDim.new(0, 3)
				UICorner_2.Parent = ColorDisplay

				cretate_button(ColorPicker).MouseButton1Click:Connect(function()
					callback(ColorDisplay.BackgroundColor3)
				end)

				ColorDisplay.MouseEnter:Connect(function()
					TweenService:Create(ColorDisplay, TweenInfo.new(0.2), {BorderColor3 = Color3.fromRGB(255, 255, 255)}):Play()
				end)

				ColorDisplay.MouseLeave:Connect(function()
					TweenService:Create(ColorDisplay, TweenInfo.new(0.2), {BorderColor3 = Color3.fromRGB(0, 0, 0)}):Play()
				end)
				...
				function button_func:Value(a)
					ColorDisplay.BackgroundColor3 = a
					callback(a)
				end
